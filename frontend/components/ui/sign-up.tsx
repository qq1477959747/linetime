      ...
      <section className="flex-1 flex items-center justify-center p-8 overflow-y-auto">
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-5">
            ...
            {onGoogleSignUp && (
              <>
                <div className="animate-element animate-delay-750 relative flex items-center justify-center">
                  <span className="w-full border-t border-border"></span>
                  <span className="px-4 text-sm text-muted-foreground bg-background absolute">或</span>
                </div>

                <button
                  onClick={onGoogleSignUp}
                  disabled={isLoading}
                  className="animate-element animate-delay-775 w-full flex items-center justify-center gap-3 border border-border rounded-2xl py-4 hover:bg-secondary transition-colors disabled:opacity-50"
                >
                  <GoogleIcon />
                  使用 Google 注册
                </button>
